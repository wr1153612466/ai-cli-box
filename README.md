...
本仓库只作为公开发布仓库使用，提供产品介绍、截图和安装包下载。开发源码维护在私有仓库 `ai-cli-box-dev`。

## 下载

请前往 GitHub Releases 下载最新版本：

- 最新版本：https://github.com/wr1153612466/ai-cli-box/releases/latest
- 全部版本：https://github.com/wr1153612466/ai-cli-box/releases
...
项目源码在私有 `ai-cli-box-dev` 仓库开发，本仓库只维护发布介绍页和 Releases。每次正式发布会在开发仓库上打 `v*.*.*` 版本标签，GitHub Actions 会自动构建 Windows 和 macOS 安装包并上传到本仓库的 GitHub Releases。

用户只需要从 Releases 页面下载对应系统版本，不需要拉取源码或本地构建。
